...
namespace ALPAKA_ACCELERATOR_NAMESPACE_CLUE {
  ...
  ALPAKA_FN_ACC void KernelResetFollowers::operator()(
      const Acc1D& acc,
  ...
  ALPAKA_FN_ACC void KernelCalculateLocalDensity::operator()(
      const Acc1D& acc,
  ...
  template <uint8_t Ndim>
  ALPAKA_FN_ACC void KernelCalculateNearestHigher::operator()(
      const Acc1D& acc,
      TilesAlpakaView<Ndim>* dev_tiles,
      PointsAlpakaView* dev_points,
      float dm,
  ...
  ALPAKA_FN_ACC void KernelFindClusters::operator()(
      const Acc1D& acc,
  ...
  ALPAKA_FN_ACC void KernelAssignClusters::operator()(
      const TAcc& acc,
      VecArray<int32_t, reserve>* seeds,
